...
$allowed_columns = array("Reference",	
                          ...
                          "profile_project_duration",
                          "profile_project_cost",	
                          "Project outline",
                          "profile_project_nobeneficiaries",
                          //"Who benefit",	
                         // "Project achieve",	
                          "profile_funding_required",	
                          "profile_registerednumber",
                          "lat",
                          "lng"
                          );
...
$file  = "20130129 Stage1 submitted Jul12-Sep12.csv"; //input file
$file  = "20130129 Stage1 submitted Oct12-Jan13.csv"; //input file
$file  = "Stage 1 Oct12-Jan13.csv"; //input file
...
$new_data["properties"]["profile_project_cost"] = array( "valueType" => "number");
$new_data["properties"]["organisation_staff"] = array( "valueType" => "number");
$new_data["properties"]["profile_funding_required"] = array( "valueType" => "number");
$new_data["properties"]["profile_project_nobeneficiaries"] = array( "valueType" => "number");
